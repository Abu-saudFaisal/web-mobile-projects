...
function Register() {
  ...
  return (
    <section className="min-h-screen bg-[#1A120B] text-white flex items-center justify-center px-6">
      ...
      >
        <h1 className="text-3xl font-bold text-[#D5A373] mb-2">Register</h1>
        <p className="text-white/70 mb-6">Create your BloomLab account.</p>
        ...
        <p className="text-white/70 mt-5 text-center">
          ...
          <Link to="/login" className="text-[#D5A373]">
            Login
          </Link>
        </p>
      </form>
